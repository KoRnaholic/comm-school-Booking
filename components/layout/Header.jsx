    ...
    <div className="fixed top-0 z-10 py-2 bg-white w-full">
      <header className="flex justify-between  items-center px-20 py-4">
        ...
        <div className="flex gap-2 items-center">
          <Link
            className="text-sm px-4 py-2 hidden md:flex hover:bg-slate-100 rounded-full text-black font-semibold"
            href=""
          >
            Airbnb your home
          </Link>
          <span className="px-3 py-3 hidden md:flex hover:bg-slate-100 rounded-full cursor-pointer">
